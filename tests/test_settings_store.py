...
class TestSettingsStore(unittest.TestCase):
    ...
    def test_save_and_load_round_trip_excludes_session_output_dir(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
    ...
    def test_load_settings_ignores_legacy_output_dir_and_sanitizes_values(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            settings_path = Path(tmpdir) / "settings.json"
